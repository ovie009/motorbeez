      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="topnav" id="myTopnav">
          <ul class="list-inline">
            <li><a href="<?php echo $allclassifed; ?>"><?php echo $text_allads; ?></a></li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-2 col-sm-2 col-xs-12 center">
        <button class="btn-primary btn-block" type="button" onclick="location.href='<?php echo $myadss; ?>'"> <i class="la la-edit"></i><?php echo $text_myadss; ?></button>
      </div>
    </div>
  </div>
</header>
