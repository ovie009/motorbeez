<div id="search">
 <select name="classified_category_id" class="selectpicker form-control bs-select-hidden">
    ...
    <div class="input-group">
          ...
          <span class="input-group-btn">
            <button type="button" class="btn btn-default btn-lg searchbtn"><i class="icon_search" aria-hidden="true"></i></button>
          </span>
    </div>
</div>
