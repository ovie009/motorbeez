...
$('select[name="store_id"]').click('change', function(e) {
	"use strict";
	$.ajax({
...
$('#path').bind('click', 'a.directory', function(e) {
	"use strict";
	e.preventDefault();
...
$('#path').bind('click', 'a.file',function(e) {
	"use strict";
	e.preventDefault();
...
$('#translation').bind('click', '#button-save', function(e) {
	"use strict";
	var node = this;
