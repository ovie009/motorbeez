          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover hidden-xs">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['classified_category_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['classified_category_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['classified_category_id']; ?>" />
                    <?php } ?></td>
			...
			<table class="table table-bordered table-hover hidden-sm hidden-lg hidden-md">
              <thead>
                <tr>
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
